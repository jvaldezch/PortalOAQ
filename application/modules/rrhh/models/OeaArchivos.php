...
class Rrhh_Model_OeaArchivos {

    protected $_db_table;

    public function __construct() {
        $this->_db_table = new Rrhh_Model_DbTable_OeaArchivos();
    }
    ...
    public function obtenerTodos($directory = null) {
        try {
            $sql = $this->_db_table->select()
                    ...
                    ->from(array("a" => "oea_archivos"), array("*"))
                    ->joinLeft(array("c" => "oea_carpetas"), "c.id = a.idCarpeta", array("carpeta"))
