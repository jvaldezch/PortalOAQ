...
window.preguntaEnviarFacturas = function() {
    $.confirm({
        title: "Enviar Edocuments y COVEs", escapeKey: "cerrar", boxWidth: "450px", useBootstrap: false, type: "red",
        buttons: {
            si: {
        ...
        content: "¿Está seguro que desea enviar Edocuments y COVEs al sistema de pedimentos? <br><br><b>Advertencia</b>: Este proceso sobreescribe los datos existentes en las facturas de la base de datos destino y no es reversible."
    });
};
...
window.enviarEdocuments = function() {
    idTrafico = $("#idTrafico").val();
    $.ajax({
        url: '/trafico/facturas/enviar-edocuments',
        data: { idTrafico: idTrafico },
        type: "POST",
        beforeSend: function () {
            $.LoadingOverlay("show", { color: "rgba(255, 255, 255, 0.9)" });
