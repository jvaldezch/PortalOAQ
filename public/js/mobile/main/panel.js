...
function newRow(item) {
    ...
    return '<tr><td>' 
            ...
            + '<a href="javascript:void(0)" onclick="viewMessages(' + item.id + ')"><i class="fa fa-envelope" aria-hidden="true"></i></a>' 
            + '</td><td>' 
            + item.nombreAduana 
            + '</td><td>' 
            ...
            + '</td><td>' 
            + ((item.fechaPrevio) ? viewIcon(item.id, 'fechaPrevio', item.fechaPrevio) : '')
            + '</td><td>' 
