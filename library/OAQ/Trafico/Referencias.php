        ...
        try {
            $sql = $this->_db->select()
                ->from(array("t" => "traficos"), array(
                    ...
                    new Zend_Db_Expr("DATE_FORMAT(fechaNotificacion,'%Y-%m-%d') AS fechaNotificacion"),
                    ...
                    new Zend_Db_Expr("DATE_FORMAT(fechaEnvioProforma,'%Y-%m-%d') AS fechaEnvioProforma"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaVistoBueno,'%Y-%m-%d') AS fechaVistoBueno"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaProformaTercero,'%Y-%m-%d') AS fechaProformaTercero"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaVistoBuenoTercero,'%Y-%m-%d') AS fechaVistoBuenoTercero"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaRevalidacion,'%Y-%m-%d') AS fechaRevalidacion"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaPrevio,'%Y-%m-%d') AS fechaPrevio"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaPago,'%Y-%m-%d') AS fechaPago"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaSolicitudTransfer,'%Y-%m-%d') AS fechaSolicitudTransfer"),
                    new Zend_Db_Expr("DATE_FORMAT(fechaArriboTransfer,'%Y-%m-%d') AS fechaArriboTransfer"),
