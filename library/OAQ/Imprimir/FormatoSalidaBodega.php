...
class OAQ_Imprimir_FormatoSalidaBodega extends TCPDF {
    ...
    public function crear() {
        ...
        $this->_fontNormal(250, $this->_data["fecha_entrada"], null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "Fecha salida:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, $this->_data["fecha_salida"], null, 2, null, null, $lineh, $fontSize);

        $this->Ln(40);
        $this->_fontNormal(150, "Descripción de mercancia:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, $this->_data["descripcionMercancia"], null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "Peso:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, $this->_data["peso_kg"] . ' kg', null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "NP:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, "", null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "Bultos:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, $this->_data["bultos"], null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "Val. Comercial:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, number_format($this->_data["valorComercial"], 2) . ' ' . $this->_data["divisa"], null, 2, null, null, $lineh, $fontSize);
        $this->Ln($ln);
        $this->_fontNormal(150, "Val. Dólares:", "R", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(250, number_format($this->_data["valorDolares"], 2), null, 2, null, null, $lineh, $fontSize);
        
        $this->Ln(110);
        $this->_fontNormal(100, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Elaboró", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(50, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Recibió", "C", 2, "", "B", $lineh, $fontSize);
        $this->Ln(50);
        $this->_fontNormal(100, "", "C", 2, "", "", $lineh, $fontSize);
        $this->_fontNormal(150, "", "C", 2, "", "", $lineh, $fontSize);
        $this->_fontNormal(50, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "", "C", 2, "", "", $lineh, $fontSize);
        $this->Ln(20);
        $this->_fontNormal(100, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Nombre y firma", "C", 2, "T", "B", $lineh, $fontSize);
        $this->_fontNormal(50, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Nombre y firma", "C", 2, "T", "B", $lineh, $fontSize);

        $this->Ln(20);
        $this->_fontNormal(300, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Línea:", "C", 2, null, "B", $lineh, $fontSize);
        $this->Ln(20);
        $this->_fontNormal(300, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Placas:", "C", 2, null, "B", $lineh, $fontSize);
        $this->Ln(20);
        $this->_fontNormal(300, "", "C", 2, "", "B", $lineh, $fontSize);
        $this->_fontNormal(150, "Operador:", "C", 2, null, "B", $lineh, $fontSize);
    }
