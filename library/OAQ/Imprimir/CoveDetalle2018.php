...
class OAQ_Imprimir_CoveDetalle2018 extends TCPDF {
    ...
    protected function _mercancia($data) {
        ...
        $this->MultiCell(340, 13 * $linecount, utf8_decode($this->_vdata($data, "descripcionGenerica")), "BL", 'L', 1, 0, '', '', true, 0, false, true, 0);
