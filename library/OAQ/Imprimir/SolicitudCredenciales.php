...
class OAQ_Imprimir_SolicitudCredenciales extends TCPDF {
    ...
    public function crear() {
        ...
        $this->MultiCell(200, 16, "Sistema o recurso", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->SetFont($this->_font, "C", $this->_fontSize);
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "SICA", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "SICA Plus", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "SITAWIN", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "Correo Electrónico", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "Portal OAQ", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln();
        $this->MultiCell(5, 16, "", 0, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(20, 16, "", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->MultiCell(200, 16, "Escáner e impresoras", 1, 'L', 0, 0, '', '', true, 0, true, true, 16, 'M');
        $this->Ln(40);
