...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Tipo de archivo no válido',
    ...
    function __construct($tmpDir, $options = null, $initialize = true, $error_messages = null) {
        
        if (!file_exists($this->_config->app->tmp . DIRECTORY_SEPARATOR . $tmpDir)) {
            mkdir($this->_config->app->tmp . DIRECTORY_SEPARATOR . $tmpDir, 0777, true);
        }
        ...
        $this->options = array(
            ...
            'upload_dir' => $this->_config->tmp->public . DIRECTORY_SEPARATOR . $tmpDir . DIRECTORY_SEPARATOR,
            'upload_url' => $this->get_full_url().'/tmp/' . $tmpDir . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
